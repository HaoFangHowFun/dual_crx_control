...
class JointTest(Node):
    def __init__(
        ...
        super().__init__('crx_periodic_j1_test')
    ...
    def run_test(self):
        ...
        self.get_logger().info(f'Joint         : {self.joint_label}')
        self.get_logger().info(
        ...
        input(
            f'Press ENTER to start periodic {self.joint_label} motion '
            'on the REAL robot...'
        )
